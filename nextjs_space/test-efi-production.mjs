...
const EFI_ENVIRONMENT = 'production'; // FORÇAR PRODUÇÃO

console.log("🧪 TESTE EFI - AMBIENTE DE PRODUÇÃO");
console.log("===================================\n");
...
console.log("Client ID:", EFI_CLIENT_ID);
...
try {
  ...
  // Passo 2: Criar Link de Pagamento (One-Step)
